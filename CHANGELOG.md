...
- Bump Native SDK from v0.7.15 to v0.8.1 ([#6](https://github.com/pombredanne/symbolicator/pull/6))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#081)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.7.15...0.8.1)
